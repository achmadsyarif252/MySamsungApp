...
class BasalMetabolicAdapter(private val listData: List<BasalMetabolicRateRecord>) :
    RecyclerView.Adapter<BasalMetabolicAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.binding.tvData.text = """
           Metabolic Rate : ${listData[position].basalMetabolicRate}
